...
class Listview extends StatefulWidget {
  const Listview({super.key, required this.post, required this.docsId});
            ...
            builder: (context, snapshot) {
              return ListView.separated(
                ...
                itemBuilder: (context, index) => InkWell(
                  ...
                  child: following.contains(widget.post[index].userid)
                      ? Column(children: [
                          Container(
                                          ...
                                          onTap: () {
                                            Navigator.of(context)
                                              ...
                                              builder: (context) => UserProfile(
                                                  uid:
                                                      widget.post[index].userid,
                                                  name:
                                                      widget.post[index].name),
                                            ));
                                          },
                                          child: Container(
                                            decoration: BoxDecoration(
